...
public class ShippingStrategy {
   ...
   private ShippingStrategy nextShipper;

   public ShippingStrategy(IOrder order, IWarehouse warehouse) {
      this.order = order;
   ...
   private ShippingStrategy getNextShipper() {
      return nextShipper;
   }
   ...
   public void setNextShipper(ShippingStrategy shipper) {
      nextShipper = shipper;
   }
